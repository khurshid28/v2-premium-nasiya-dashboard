...
const Contracts = (): JSX.Element => {
  ...
  const api = apiReal; // Shartnomalar faqat real API ishlatadi
  ...
  const [statusFilter, setStatusFilter] = React.useState("FINISHED"); // Default: faqat tugatilganlar
    ...
    <div>
      ...
      <DetailModal
              ...
              onViewFull={selected ? () => {
                ...
                navigate(`${basePath}/contract/${selected.id}`);
                setOpen(false);
              } : undefined}
            >
              {detailLoading ? (
